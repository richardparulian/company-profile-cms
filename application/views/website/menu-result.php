            ...
            <form action="<?= base_url('menu-search-post'); ?>" method="post" style="margin-bottom: 7rem;">
                <div class="row">
                    <div class="col-md-6 col-sm-12" style="display: flex;">
                        <input type="text" class="form-control" name="search_menu_book" placeholder="Search by Menu Name & Description..." style="border-radius: 24px; height: 4.5rem; margin-right: 15px;" />
                ...
                <?php if (end($this->uri->segments) == 'search') : ?>
                    <div style="margin: 10px 0 0 5px; color: #777777; font-size: 1.1em;">
                        <span><?= '"' . $getMenuBook['keyword'] . '" ' . $getMenuBook['countResult'] . ' results found'; ?></span>
                    </div>
                <?php endif; ?>
            </form>

            <?php if ($getMenuBook['countResult'] == 0) : ?>
                <div class="error-block container-fluid row align-items-center" style="display: flex; flex-wrap: wrap">
                    <div class="col-12 col-md-5 text-center">
                        <img src="<?= base_url('assets/website/images/not-found.jpg'); ?>" alt="menu-not-found.jpeg" />
                    </div>
                    <div class="col-12 col-md-7">
                        <h3>There is no menu matching that search right now.</h3>
                    </div>
                </div>
            <?php else : ?>
                ...
                <!-- Row -->
                <div class="row">
                    <?php foreach ($getMenuBook['result'] as $menu) : ?>
                        <!-- Menu Item -->
                        <div class="col-md-6">
                            <div class="menu-item">
