    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-sm-8 content-area">
                <?php if ($getBlog['countResult'] == 0) : ?>

                    <div class="error-block container-fluid row align-items-center" style="display: flex; flex-wrap: wrap">
                        <div class="col-12 col-md-5 text-center">
                            <img src="<?= base_url('assets/website/images/not-found.jpg'); ?>" alt="not-found.jpg" />
                        </div>
                        <div class="col-12 col-md-7">
                            <h3>Service blog not found. Type and search for the things you desire.</h3>
                        </div>
                    </div>

                <?php else : ?>

                    <?php foreach ($getBlog['result'] as $blog) : ?>
                        <div class="type-post">
