            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form enctype="multipart/form-data" action="<?= base_url("add-career"); ?>" class="row g-3" method="post">

                            <div class="col-md-6">
                                <label for="inputNanme4" class="form-label">Careers From</label>
                                <input type="text" class="form-control datepicker" name="career_from" placeholder="From" required />
                            </div>

                            <div class="col-md-6">
                                <label for="inputNanme4" class="form-label">Careers Until</label>
                                <input type="text" class="form-control datepicker" name="career_until" placeholder="Until" required />
                            </div>

                            <div class="col-md-12">
                                <label for="inputNanme4" class="form-label">Career Title</label>
                                <input type="text" rows="5" class="form-control" name="career_title" placeholder="Career Title" required />
                            </div>

                            <div class="col-md-12">
                                <label for="inputNanme4" class="form-label">Careers Description</label>
                                <textarea id="ckeditor" class="form-control" name="career_desc" required></textarea>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <input class="form-control" type="file" name="career_image" id="formFile" required>
